...
//アニメーション
#include "AnimatorList/Animator.h"
//影
...
public:
    ...
    /// <param name="camera">プレイヤーのカメラのポインタ</param>
    Player(
    ...
    /// プレイヤーの正面方向ベクトルを取得
    /// </summary>
    /// <returns>現在の正面方向　m_forward</returns>
    ...
    /// </summary>
    /// <returns>移動速度　moveSpeed</returns>
    ...
    /// 現在のHPを取得
    /// </summary>
    /// <returns>現在のHP　m_stats.hp</returns>
    float GetHP() const { return m_stats.hp; }

    /// <summary>
    /// 現在のスタミナを取得
    /// </summary>
    /// <returns>現在のスタミナ　m_stats.stamina</returns>
    float GetStamina() const { return m_stats.stamina; }

    /// <summary>
    /// 弾数を取得用
    /// </summary>
    /// <returns>現在の弾数　m_stats.ammo</returns>
    int GetAmmo() const { return m_stats.ammo; }
    
    /// <summary>
    /// 最大弾数を取得
    /// </summary>
    /// <returns>m_stats.ammo_Max</returns>
    ...
    /// プレイヤーがやられているかを判定
    /// </summary>
    /// <returns>やられた　m_stats.hpが０以下のときtrue</returns>
