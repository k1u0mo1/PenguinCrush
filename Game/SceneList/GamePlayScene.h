...
private:
	...
	//終了時の待機
	static constexpr float FINISH_WAIT_TIME = 3.0f; 
	...
	//ヒットストップ時間
	static constexpr float HIT_STOP_TIME_SCALE = 0.1f;
	static constexpr float NORMAL_TIME_SCALE = 1.0f;

	//カメラの定数
	static constexpr float CAMERA_FOV = 45.0f;
	static constexpr float CAMERA_NEAR_CLIP = 0.1f;
